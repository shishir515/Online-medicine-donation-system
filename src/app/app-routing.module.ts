...
const routes: Routes = [
  ...
  {path: 'user', component: UserpageComponent,  canActivate: [AngularFireAuthGuard], data: { authGuardPipe: redirectUnauthorizedToLogin }},
  // tslint:disable-next-line: max-line-length
  {path: 'add', component: AddmedicineComponent,  canActivate: [AngularFireAuthGuard], data: { authGuardPipe: redirectUnauthorizedToLogin }},
  // tslint:disable-next-line: max-line-length
  {path: 'viewall', component: ViewmedicineComponent,  canActivate: [AngularFireAuthGuard], data: { authGuardPipe: redirectUnauthorizedToLogin }},
